...
public abstract class PoolFilter {
     ...
     * @return the filtered pool of candidate vehicles and their corresponding routes.
     */
     ...
     * @return the filtered pool of candidate requests and their corresponding routes.
     */
